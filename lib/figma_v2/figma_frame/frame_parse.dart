...
*/
Map<String, dynamic> parseFigmaFrame(
    Map<String, dynamic> figmaData, ScreenSizeInfo screenSizeInfo,
    {bool isRoot = false}) {
  ...
  Map<String, dynamic> _parseStyle() {
    return {
      ...
      "boxRadius": figmaData.containsKey("rectangleCornerRadii")
          ...
          : null,
      "boxShadow": !figmaData.containsKey("effects")
          ? []
          : figmaData["effects"]
              .map((effect) => {
                    "color": getColorString(
                        safeGet(key: "color", map: effect, alt: null)),
  ...
  Map<String, dynamic> out = {
    ...
    "layoutMode": (figmaData.containsKey("layoutMode"))
        ? figmaData["layoutMode"] == "HORIZONTAL"
            ? "Row"
            : figmaData["layoutMode"] == "VERTICAL"
                ? "Column"
                : "Stack"
        : "Stack",
    //"blendMode":,
    ...
    "children": figmaData.containsKey("children")
        ? figmaData["children"].map((childData) => childData["id"]).toList()
        : [],
    "transitionNode": null
  };
  // printJson(out);
