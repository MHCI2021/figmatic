...
Color colorFromString(String color){
  ...
  List<int> parts=[];
  if(e.containsKey(color))return e[color](500, 1.0);
  if(e.containsKey(color.substring(0, color.length-3)))return e[color.substring(0, color.length-3)](int.tryParse(color.substring(color.length-3))??500, 1.0);
